 ...
 *
 * @note The width and height are signed integers because OpenGL uses signed
 * integers, even though the dimensions of an image are always positive.
 */
struct Resolution {
    std::int32_t width{};
    std::int32_t height{};
